...
##############################################################################
{
    ...
    'summary': 'A modern bank reconciliation workspace for Odoo 18 Community Edition with a five-signal suggestion engine that ranks candidate journal items by confidence, so an operator confirms each match with one click or a drag. Odoo 18 Community bank reconciliation, bank reconciliation widget Odoo Community, reconciliation suggestion engine, auto match bank statement lines, user-defined reconciliation rules, reconciliation audit log, bank statement reconciliation workspace, FX rounding write-off, reconciliation exception report.',
    'description': """Bank Reconciliation Pro gives Odoo 18 Community a reconciliation experience built around a scored suggestion engine and a tamper-evident audit trail.
