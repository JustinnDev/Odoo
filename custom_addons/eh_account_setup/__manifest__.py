...
##############################################################################
{
    ...
    'summary': "A guided accounting onboarding checklist for Odoo 18 Community that turns the suite's strict configuration errors into 26 tracked setup tasks across 7 categories, each with a deep link into the exact configuration screen. Per-company progress, module-aware visibility, fail-loud deep links, completion ratio that excludes skipped tasks, and a full audit trail. Odoo 18 accounting setup checklist, accounting onboarding guide, multi company configuration tracker, first install accounting setup, guided accounting configuration, per company setup progress, consultant rollout tracker, deep link to configuration screens.",
