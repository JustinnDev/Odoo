...
##############################################################################
{
    ...
    'summary': 'Keep IAS 8 accounting changes and IAS 10 subsequent events on a controlled register in Odoo 18 Community, with retrospective restatement of comparatives and optional general ledger posting. Search terms: odoo 19 IAS 8, prior period error correction, change in accounting policy, retrospective restatement of comparatives, as previously reported adjustment as restated, change in accounting estimate prospective, opening retained earnings restatement, IAS 10 events after the reporting period, adjusting non-adjusting event, authorised for issue date, dividend declared after year end.',
