...
##############################################################################
{
    ...
    'summary': 'SEPA Direct Debit collection for Odoo 18 Community. Generate ISO 20022 PAIN.008.001.02 XML written from the public spec, run the full FRST, RCUR, FNAL, OOFF mandate lifecycle with an atomic sequence counter, and block non-compliant exports before they reach the bank. Search terms: SEPA direct debit Odoo 18, PAIN.008.001.02 XML generator, SEPA mandate management, FRST RCUR FNAL OOFF sequence type, SEPA creditor identifier, CORE B2B COR1 direct debit scheme, 36-month mandate dormancy, recurring direct debit collection, IBAN BIC validation, SEPA direct debit Community edition.',
    'description': """SEPA Direct Debit for Odoo 18 Community collects EUR payments from customer bank accounts via the SEPA Direct Debit scheme. It pairs with the Recurring Invoices module for subscription collection and with Batch Payment for ad-hoc collection runs.
